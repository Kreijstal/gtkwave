                ...
                if click_mysim(mysim_cell, app):
                    ...
                    if sine_wave_cell:
                        ...
                        if double_click_sine_wave(sine_wave_cell, app):
                            ...
                            highlight_all_item = find_menu_item(app, "Edit", "Highlight All")
                            if highlight_all_item:
                                ...
                                if click_menu_item(highlight_all_item, app):
                                    ...
                                    toggle_group_item = find_menu_item(app, "Edit", "Toggle Group Open|Close")
                                    if toggle_group_item:
                                        print("Found 'Toggle Group Open|Close' menu item")
                                        if click_menu_item(toggle_group_item, app):
                                            print("Success! Clicked 'Toggle Group Open|Close'")
                                            return 0
                                        else:
                                            print("Failed to click 'Toggle Group Open|Close'")
                                            return 1
                                    else:
                                        print("'Toggle Group Open|Close' menu item not found")
                                        return 1
                                else:
