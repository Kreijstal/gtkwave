/*
 * REFERENCE FILE THE CODEBASE/API HERE IS OLD BUT THE ALGORITHM SHOULD WORK
 */
...
int consume(void) /* for testing only */
{
    ...
    if ((len = *GLOBALS->consume_ptr_vcd_partial_c_1)) {
        ...
        for (i = 0; i < len; i++) {
            GLOBALS->vcdbuf_vcd_partial_c_2[i] =
                get_8(GLOBALS->consume_ptr_vcd_partial_c_1 + i + 5);
        }
        ...
        *GLOBALS->consume_ptr_vcd_partial_c_1 = 0;
        ...
        if (GLOBALS->consume_ptr_vcd_partial_c_1 >=
            (GLOBALS->buf_vcd_partial_c_2 + WAVE_PARTIAL_VCD_RING_BUFFER_SIZE)) {
...
static struct vcdsymbol *bsearch_vcd(char *key, int len)
{
    ...
    if (GLOBALS->indexed_vcd_partial_c_2) {
        ...
        if ((hsh >= GLOBALS->vcd_minid_vcd_partial_c_2) &&
            (hsh <= GLOBALS->vcd_maxid_vcd_partial_c_2)) {
    ...
    if (GLOBALS->sorted_vcd_partial_c_2) {
        v = (struct vcdsymbol **)bsearch(key,
                                         GLOBALS->sorted_vcd_partial_c_2,
        ...
        if (!GLOBALS->err_vcd_partial_c_2) {
            fprintf(stderr,
                    ...
                    (int)(GLOBALS->vcdbyteno_vcd_partial_c_2 +
                          (GLOBALS->vst_vcd_partial_c_2 - GLOBALS->vcdbuf_vcd_partial_c_2)));
...
static void create_sorted_table(void)
{
    ...
    if (GLOBALS->numsyms_vcd_partial_c_2) {
        ...
        if ((vcd_distance <= VCD_INDEXSIZ) || (!GLOBALS->vcd_hash_kill_partial)) {
            ...
            while (v) {
                if (!GLOBALS->indexed_vcd_partial_c_2[v->nid - GLOBALS->vcd_minid_vcd_partial_c_2])
                    GLOBALS->indexed_vcd_partial_c_2[v->nid - GLOBALS->vcd_minid_vcd_partial_c_2] =
                        v;
                v = v->next;
            }
        } else {
            pnt = GLOBALS->sorted_vcd_partial_c_2 =
                (struct vcdsymbol **)calloc_2(GLOBALS->numsyms_vcd_partial_c_2,
                                              sizeof(struct vcdsymbol *));
            v = GLOBALS->vcdsymroot_vcd_partial_c_2;
            while (v) {
                *(pnt++) = v;
            ...
            qsort(GLOBALS->sorted_vcd_partial_c_2,
                  GLOBALS->numsyms_vcd_partial_c_2,
                  sizeof(struct vcdsymbol *),
                  vcdsymcompare);
        }
...
{
    GLOBALS->vend_vcd_partial_c_2 = GLOBALS->vst_vcd_partial_c_2 = GLOBALS->vcdbuf_vcd_partial_c_2 =
...
static int getch_fetch(void)
{
    ...
    GLOBALS->vcdbyteno_vcd_partial_c_2 +=
        (GLOBALS->vend_vcd_partial_c_2 - GLOBALS->vcdbuf_vcd_partial_c_2);
    rd = consume();
    GLOBALS->vend_vcd_partial_c_2 =
        (GLOBALS->vst_vcd_partial_c_2 = GLOBALS->vcdbuf_vcd_partial_c_2) + rd;
...
{
    signed char ch = ((GLOBALS->vst_vcd_partial_c_2 != GLOBALS->vend_vcd_partial_c_2)
                          ? ((int)(*GLOBALS->vst_vcd_partial_c_2))
                          : (getch_fetch()));
    if (ch >= 0) {
        GLOBALS->vst_vcd_partial_c_2++;
    };
    return (ch);
}
...
static int get_token(void)
{
    ...
    for (GLOBALS->yytext_vcd_partial_c_2[len++] = ch;;
         GLOBALS->yytext_vcd_partial_c_2[len++] = ch) {
        if (len == GLOBALS->T_MAX_STR_vcd_partial_c_2) {
            GLOBALS->yytext_vcd_partial_c_2 = (char *)realloc_2(
                GLOBALS->yytext_vcd_partial_c_2,
                (GLOBALS->T_MAX_STR_vcd_partial_c_2 = GLOBALS->T_MAX_STR_vcd_partial_c_2 * 2) + 1);
        }
        ch = getch();
        if (ch <= ' ')
            break;
...
static int get_vartoken(int match_kw)
{
    ...
    for (GLOBALS->yytext_vcd_partial_c_2[len++] = ch;;
        ...
        if (ch == ' ') {
            ...
            if (getch_peek() == '[') {
                ch = getch();
                GLOBALS->varsplit_vcd_partial_c_2 = GLOBALS->yytext_vcd_partial_c_2 +
        ...
        if ((ch == '[') && (GLOBALS->yytext_vcd_partial_c_2[0] != '\\')) {
            GLOBALS->varsplit_vcd_partial_c_2 =
                GLOBALS->yytext_vcd_partial_c_2 + len; /* keep looping so we get the *last* one */
        } else if (((ch == ':') || (ch == ']')) && (!GLOBALS->varsplit_vcd_partial_c_2) &&
                   (GLOBALS->yytext_vcd_partial_c_2[0] != '\\')) {
            GLOBALS->var_prevch_vcd_partial_c_2 = ch;
            break;
        }
    }
...
static void sync_end(const char *hdr)
{
    ...
    for (;;) {
        ...
        if ((tok == T_END) || (tok == T_EOF))
            break;
        if (hdr) {
            DEBUG(fprintf(stderr, " %s", GLOBALS->yytext_vcd_partial_c_2));
        }
    }
    if (hdr) {
...
static int version_sync_end(const char *hdr)
{
    ...
    for (;;) {
        ...
        if (strstr(GLOBALS->yytext_vcd_partial_c_2,
    ...
    switch (GLOBALS->yytext_vcd_partial_c_2[0]) {
        ...
        case '-':
            if (GLOBALS->yylen_vcd_partial_c_2 > 1) {
                v = bsearch_vcd(GLOBALS->yytext_vcd_partial_c_2 + 1,
                                GLOBALS->yylen_vcd_partial_c_2 - 1);
                if (!v) {
                    fprintf(stderr,
                            "Near byte %d, Unknown VCD identifier: '%s'\n",
                            (int)(GLOBALS->vcdbyteno_vcd_partial_c_2 +
                                  (GLOBALS->vst_vcd_partial_c_2 - GLOBALS->vcdbuf_vcd_partial_c_2)),
                            GLOBALS->yytext_vcd_partial_c_2 + 1);
                } else {
                    v->value[0] = GLOBALS->yytext_vcd_partial_c_2[0];
                    DEBUG(fprintf(stderr, "%s = '%c'\n", v->name, v->value[0]));

                    v->narray[0]->curr = v->app_array[0];
                    /* hsuf = */ add_histent_p(GLOBALS->current_time_vcd_partial_c_2,
                                               v->narray[0],
                                               v->value[0],
                                               1,
                                               NULL); /* scan-build */
                    ...
                    if (v->narray[0]->harray) {
                        free_2(v->narray[0]->harray);
                        v->narray[0]->harray = NULL;
                    }
                }
            } else {
                fprintf(stderr,
        ...
        case 'B': {
            ...
            vector =
                malloc_2(GLOBALS->yylen_cache_vcd_partial_c_2 = GLOBALS->yylen_vcd_partial_c_2);
            ...
            if (!v) {
                fprintf(stderr,
                        "Near byte %d, Unknown identifier: '%s'\n",
                        (int)(GLOBALS->vcdbyteno_vcd_partial_c_2 +
                              (GLOBALS->vst_vcd_partial_c_2 - GLOBALS->vcdbuf_vcd_partial_c_2)),
                        GLOBALS->yytext_vcd_partial_c_2);
                free_2(vector);
                ...
                if ((v->vartype == V_REAL) || (v->vartype == V_STRINGTYPE) ||
                    ...
                    *d = (double)k;
                    ...
                    if (!v) {
                        ...
                        v->narray[0]->curr = v->app_array[0];
                        add_histent_p(GLOBALS->current_time_vcd_partial_c_2,
                                      v->narray[0],
                                      'g',
                                      1,
                                      (char *)d);
                ...
                if (v->size == 1) {
                    ...
                    for (i = 0; i < v->size; i++) {
                        ...
                        if (v->narray[i]->harray) {
                            free_2(v->narray[i]->harray);
                            v->narray[i]->harray = NULL;
                        }
                    }
                    free_2(vector);
                } else {
        ...
        case 'S': {
            ...
            vlen = fstUtilityEscToBin((unsigned char *)d,
                                      (unsigned char *)(GLOBALS->yytext_vcd_partial_c_2 + 1),
                                      GLOBALS->yylen_vcd_partial_c_2); /* includes 0 term */
        ...
        switch (get_token()) {
            ...
            case T_TIMESCALE: {
                ...
                for (i = 0; i < GLOBALS->yylen_vcd_partial_c_2; i++) {
                    if ((GLOBALS->yytext_vcd_partial_c_2[i] < '0') ||
                        (GLOBALS->yytext_vcd_partial_c_2[i] > '9')) {
                ...
                T_GET;
                {
                    switch (GLOBALS->yytext_vcd_partial_c_2[0]) {
                        ...
                        case 't':
                            ...
                            break;
                        case 'f':
                            ttype = (GLOBALS->yytext_vcd_partial_c_2[1] == 'u')
                        ...
                        case 'i':
                            ...
                            break;
                        case 'p':
                            ttype = (GLOBALS->yytext_vcd_partial_c_2[1] == 'r')
            ...
            case T_VAR:
                if ((GLOBALS->header_over_vcd_partial_c_2) && (0)) {
                    ...
                    if (vtok == V_PORT) {
                        ...
                        if (v->nid < GLOBALS->vcd_minid_vcd_partial_c_2)
                            GLOBALS->vcd_minid_vcd_partial_c_2 = v->nid;
                        if (v->nid > GLOBALS->vcd_maxid_vcd_partial_c_2)
                            GLOBALS->vcd_maxid_vcd_partial_c_2 = v->nid;
                        ...
                        if (GLOBALS->slisthier_len) {
                            ...
                            if (GLOBALS->alt_hier_delimeter) {
                                ...
                                if ((strcpy_delimfix(v->name + GLOBALS->slisthier_len + 1,
                                    ...
                                    char *sd = (char *)malloc_2(GLOBALS->slisthier_len + 1 +
                                                                GLOBALS->yylen_vcd_partial_c_2 + 2);
                            ...
                            if (GLOBALS->alt_hier_delimeter) {
                                ...
                                if ((strcpy_delimfix(v->name, GLOBALS->yytext_vcd_partial_c_2)) &&
                                    (GLOBALS->yytext_vcd_partial_c_2[0] != '\\')) {
                        ...
                        if (GLOBALS->pv_vcd_partial_c_2) {
                            if (!strcmp(GLOBALS->pv_vcd_partial_c_2->name, v->name) &&
                                ...
                                if (GLOBALS->pv_vcd_partial_c_2 == GLOBALS->rootv_vcd_partial_c_2)
                                    GLOBALS->pv_vcd_partial_c_2->root =
                                        GLOBALS->rootv_vcd_partial_c_2;
                            } else {
                ...
                dumpv:
                    ...
                    if (!GLOBALS->vcdsymroot_vcd_partial_c_2) {
                        GLOBALS->vcdsymroot_vcd_partial_c_2 = GLOBALS->vcdsymcurr_vcd_partial_c_2 =
                            v;
                    } else {
                    ...
                    if (v) {
                        ...
                        if (v->name) {
                            fprintf(stderr,
                                    ...
                                    (int)(GLOBALS->vcdbyteno_vcd_partial_c_2 +
                                          (GLOBALS->vst_vcd_partial_c_2 -
                                           GLOBALS->vcdbuf_vcd_partial_c_2)),
                                    v->name);
                            free_2(v->name);
                        } else {
                            fprintf(stderr,
            ...
            case T_DUMPPORTS:
                if (GLOBALS->current_time_vcd_partial_c_2 < 0) {
                    GLOBALS->start_time_vcd_partial_c_2 = GLOBALS->current_time_vcd_partial_c_2 =
                        GLOBALS->end_time_vcd_partial_c_2 = 0;
                }
                break;
            case T_VCDCLOSE:
                sync_end("VCDCLOSE:");
            ...
            default: {
                if (!(rc = n->curr)) {
                    ...
                    if ((n->curr->v.h_vector && vector && (strcmp(n->curr->v.h_vector, vector))) ||
                        (tim == GLOBALS->start_time_vcd_partial_c_2) || (!n->curr->v.h_vector) ||
                        (GLOBALS->vcd_preserve_glitches)) /* same region == go skip */
                    {
                        if (n->curr->time == tim) {
                            DEBUG(printf("Warning: Glitch at time [%" GW_TIME_FORMAT
    ...
    while (v) {
        if ((v->vartype == V_REAL) || (v->vartype == V_STRINGTYPE)) {
            ...
            *d = 1.0;
            ...
            rc = add_histent_p(MAX_HISTENT_TIME - 1,
                               v->narray[0],
                               'x',
                               0,
                               (char *)calloc_2(1, sizeof(char)));
            set_vcd_vartype(v, v->narray[0]);
            v->app_array[0] = rc;
            v->tr_array[0] = v->narray[0]->curr;
        }
    ...
    while (v) {
        if ((v->vartype == V_REAL) || (v->vartype == V_STRINGTYPE)) {
            ...
            *d = 0.0;
            ...
            add_histent_p(MAX_HISTENT_TIME,
                          v->narray[0],
                          'z',
                          0,
                          (char *)calloc_2(1, sizeof(char)));
...
GwTime vcd_partial_main(char *fname)
{
    ...
    {
        if (!strcmp(fname, "-vcd")) {
            if (!fscanf(stdin, "%x", &shmidu))
                shmidu = ~(0L); /* allow use of -v flag to pass straight from stdin */
        } else {
...
#ifdef __MINGW32__
    {
        ...
        GLOBALS->consume_ptr_vcd_partial_c_1 = GLOBALS->buf_vcd_partial_c_2 =
    ...
    if (GLOBALS->partial_vcd) {
        ...
        while (*GLOBALS->consume_ptr_vcd_partial_c_1) {
            ...
            if (!GLOBALS->timeset_vcd_partial_c_1) {
                GLOBALS->tims.first = GLOBALS->tims.start = GLOBALS->tims.laststart =
                    GLOBALS->min_time;
...
static void vcd_partial_regen_node_expansion(GwTrace *t)
{
    if (!t->vector) {
        if (t->n.nd && t->n.nd->expansion) {
            ...
            t->name = (GLOBALS->hier_max_level)
                          ? hier_extract(t->name_full, GLOBALS->hier_max_level)
                          : t->name_full;
        }
    }
}
